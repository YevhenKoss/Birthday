...
users = [
    {"name": "Bill", "birthdate": datetime(year=1990, month=12, day=31)},
    {"name": "Gill", "birthdate": datetime(year=1990, month=1, day=1)},
    {"name": "Till", "birthdate": datetime(year=1990, month=1, day=5)},
    {"name": "Dill", "birthdate": datetime(year=1990, month=1, day=6)},
    {"name": "Bilg", "birthdate": datetime(year=1990, month=1, day=7)},
    {"name": "Gilg", "birthdate": datetime(year=1990, month=1, day=5)},
    {"name": "Tilg", "birthdate": datetime(year=1990, month=1, day=6)},
    {"name": "Dilg", "birthdate": datetime(year=1990, month=1, day=20)},
]
...
def get_birthdays_per_week(users: list):
    ...
    for user in users:
        ...
        cur_year_bd = user_bd.replace(str(user_bd[0:4]), str(current_date.year))
